...
/**
 * @brief Using the whip protocol://datatracker.ietf.org/doc/html/draft-ietf-wish-whip-01
 * @note Currently only supports start/stop for p2p connection
 */
class WhipClient {
  ...
  /**
   * @brief p2p connection, offer exchange
   */
